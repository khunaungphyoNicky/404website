            ...
            <div class="pt-6 pb-8 px-6">
                ...
                <ul role="list" class="mt-4 space-y-3">
                    <li class="flex space-x-3">
                        ...
                        <span class="text-base text-slate-700">Contains Ads</span>
                    </li>
                    <li class="flex space-x-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 h-5 w-5 text-green-400" width="24"
                            height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                        ...
                        <span class="text-base text-slate-700">Add time features</span>
                    </li>
                    <li class="flex space-x-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 h-5 w-5 text-green-400" width="24"
                            height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                        ...
                        <span class="text-base text-slate-700">Access to limited servers</span>
                    </li>
                    <li class="flex space-x-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 h-5 w-5 text-green-400" width="24"
                            height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
            ...
            <div class="pt-6 pb-8 px-6">
                ...
                <ul role="list" class="mt-4 space-y-3">
                    <li class="flex space-x-3">
                        ...
                        <span class="text-base text-slate-700">Extra 10 days</span>
                    </li>
                    <li class="flex space-x-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 h-5 w-5 text-green-400" width="24"
                            height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                        ...
                        <span class="text-base text-slate-700">No Ads and add time</span>
                    </li>
                    ...
                    <li class="flex space-x-3">
                        ...
                        <span class="text-base text-slate-700">Priority Support</span>
                    </li>
                </ul>
            </div>
        </div>
