<template>   
  <div class=" scroll-smooth bg-slate-100">     
    <div v-if="status"       
      ...
      <a class="hover:text-[#147EFB] duration-200 ease-in-out" href="#servers" @click="close()">Servers</a>       
    ...
    <nav class=" bg-white shadow-md shadow-gray-200 items-center nav-bar h-[80px] py-6 px-12 text-black flex justify-between fixed top-0 w-full z-10">       
      ...
      <div class="menu flex gap-6 font-bold text-[17.6px] opacity-80">         
        ...
        <a class="hover:text-[#147EFB] duration-200 ease-in-out" href="#servers">Servers</a>         
